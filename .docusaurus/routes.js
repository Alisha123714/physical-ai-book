        ...
        routes: [
          {
            ...
            routes: [
              ...
              },
              {
                ...
                component: ComponentCreator('/docs/module-1-ros2', '3bb'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/module-2-simulation',
                component: ComponentCreator('/docs/module-2-simulation', '393'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/module-3-isaac',
                component: ComponentCreator('/docs/module-3-isaac', '4ef'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/module-4-vla',
                component: ComponentCreator('/docs/module-4-vla', '84b'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
